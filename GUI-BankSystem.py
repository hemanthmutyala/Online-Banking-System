...
def write(master,name,oc,pin):
	...
	frec.write("Date		Time  	Credit      Debit     Balance\n")
...
def De_Amt(accnt,name):
	...
	l_title=tk.Message(debitwn,text="Pavan BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
